...
def font_properties():
    ...
    proptitle = font_manager.FontProperties(
        fname=f'{ruta_fuentes}AvenirLTStd-Medium.otf')
    propticks = font_manager.FontProperties(
        fname=f'{ruta_fuentes}AvenirLTStd-Book.otf', size=18)
    proplatlon = font_manager.FontProperties(
        fname=f'{ruta_fuentes}AvenirLTStd-Book.otf', size=18)
    proplegend = font_manager.FontProperties(
        fname=f'{ruta_fuentes}AvenirLTStd-Book.otf', size=16)
    proptitlebar = font_manager.FontProperties(
        fname=f'{ruta_fuentes}AvenirLTStd-Book.otf', size=18)
    return proptitle, propticks, proplatlon, proplegend, proptitlebar
